...
func TestChannelHealthProbeEndpointTypeForImagePaths(t *testing.T) {
	require.Equal(t, string(constant.EndpointTypeGemini), channelHealthProbeEndpointType("/v1beta/models/gemini-test:generateContent"))
	require.Equal(t, string(constant.EndpointTypeGemini), channelHealthProbeEndpointType("/v1beta/models/gemini-test:streamGenerateContent"))
