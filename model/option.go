...
func InitOptionMap() {
	...
	common.OptionMap["GroupDisplayOrder"] = setting.GroupDisplayOrder2JSONString()
	...
	common.OptionMap["ImageGroupPrice"] = ratio_setting.ImageGroupPrice2JSONString()
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "GroupDisplayOrder":
		err = setting.UpdateGroupDisplayOrderByJSONString(value)
	...
	case "ImageGroupPrice":
		err = ratio_setting.UpdateImageGroupPriceByJSONString(value)
	case "AudioRatio":
